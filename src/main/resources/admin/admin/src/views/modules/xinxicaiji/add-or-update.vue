<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="近期住址" prop="jinqizhuzhi">
          <el-input v-model="ruleForm.jinqizhuzhi" 
              placeholder="近期住址" clearable  :readonly="ro.jinqizhuzhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="近期住址" prop="jinqizhuzhi">
              <el-input v-model="ruleForm.jinqizhuzhi" 
                placeholder="近期住址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="不良情况" prop="buliangqingkuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="不良情况"
                  v-model="ruleForm.buliangqingkuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.buliangqingkuang" label="不良情况" prop="buliangqingkuang">
                    <span>{{ruleForm.buliangqingkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="外出地点" prop="waichudidian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="外出地点"
                  v-model="ruleForm.waichudidian" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.waichudidian" label="外出地点" prop="waichudidian">
                    <span>{{ruleForm.waichudidian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jinqizhuzhi'){
            this.ruleForm.jinqizhuzhi = obj[o];
	    this.ro.jinqizhuzhi = true;
            continue;
          }
          if(o=='jiatingzhuzhi'){
	    ...
	    this.ro.jiatingzhuzhi = true;
          ...
          if(o=='buliangqingkuang'){
            this.ruleForm.buliangqingkuang = obj[o];
	    this.ro.buliangqingkuang = true;
            continue;
          }
          if(o=='waichudidian'){
            this.ruleForm.waichudidian = obj[o];
	    this.ro.waichudidian = true;
            continue;
          }
          if(o=='tiwen'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xinxicaiji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xinxicaijiCrossAddOrUpdateFlag = false;
                  this.parent.search();
